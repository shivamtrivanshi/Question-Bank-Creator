...
function addPost() {
    ...
    var data = {
        ...
        _ui.ui.showAlert("Please Fill Out All Fields", "alert alert-danger");
    } else {

        if (id === "") {
            //Create Post 
            _http.http.post("http://localhost:3000/posts", data).then(function (data) {
                _ui.ui.showAlert("Answer Added", "alert alert-success");
                _ui.ui.clearFields();
                getPosts();
            }).catch(function (err) {
                console.log(err);
            ...
            _http.http.put("http://localhost:3000/posts/" + id, data).then(function (data) {
                _ui.ui.showAlert("Answer Updated", "alert alert-success");
                _ui.ui.clearFields();
...
function deletePost(e) {
    if (e.target.parentElement.classList.contains("delete")) {
        ...
        if (confirm("Are You Sure?")) {
            _http.http.delete("http://localhost:3000/posts/" + id).then(function (resData) {
                _ui.ui.showAlert("Successfully Deleted", "alert alert-success");
                getPosts();
            }).catch(function (err) {
                console.log(err);
            });
...
function editPost(e) {
    if (e.target.parentElement.classList.contains("edit")) {
        var id = e.target.parentElement.dataset.id;
        var question = e.target.parentElement.previousElementSibling.previousElementSibling.textContent;
        var answer = e.target.parentElement.previousElementSibling.textContent;
...
var ServeHTTP = function () {
    function ServeHTTP() {
        _classCallCheck(this, ServeHTTP);
    }

    _createClass(ServeHTTP, [{
        key: "get",
...
var http = exports.http = new ServeHTTP();
    ...
    _createClass(UI, [{
        ...
        value: function changeFormState(type) {
            if (type === "edit") {
                ...
                //Get parent
                var container = document.querySelector(".card-form");
